...
Logo Showcase with Carousel Slider that can display clients, supporters, partners or sponsors logos in your website.

== Description ==

Logo Slider WP is a responsive and easy to implement carousel slider plugin for wordpress. With this plugin you can showcase a list of clients, supporters, partners or sponsors logos in your website. You can Create a grid of images with suitable links. This logo showcase plugin works great on mobiles and tablets.
...
= Logo Slider Live Demo =

Live Preview link: [View Demo](http://logichunt.com/wordpress-logo-caurosel-slider-demo-page/)

Available Shortcode Options : [Plugin Page](http://logichunt.com/product/wordpress-logo-slider/)
...
2. Create new slides
3. Include Plugin in your in any content. e.g. post, page, widget, theme
4. Set Default Options from Plugin Settings Menu
...
Please Visit Product Page for All Shortcode Options: [ Logo Slider Page.](http://logichunt.com/product/wordpress-portfolio-gallery/)


= Support =

Get Support from Developer: [Support Link](http://logichunt.com/support/)
